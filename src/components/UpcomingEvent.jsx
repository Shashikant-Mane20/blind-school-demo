...
const UpcomingEvent = ({ speechEnabled }) => {
  ...
  const posts = [
    ...
    },
    {
      id: 2,
      imageUrl:
        "https://plus.unsplash.com/premium_photo-1665520346744-e7925b11bc34?q=80&w=1936&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 3,
      imageUrl:
    ...
    },
    {
      id: 5,
      imageUrl:
        "https://plus.unsplash.com/premium_photo-1690479511578-6f9bf096b5e6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 6,
      imageUrl:
  ...
  return (
    <section className="py-20 bg-gray-50 mx-4 md:mx-16">
      ...
      <div
        ...
        onClick={() =>
          speakText(
            "Upcoming Event, Special sessions and workshops to empower blind students, assistive technology, and advocacy for accessibility in education."
          )
        }
      >
        ...
        <p className="text-xl text-gray-700 mt-4">
          Special sessions and workshops to empower blind students, assistive
          technology, and advocacy for accessibility in education.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="flex flex-col gap-6 md:w-1/2 md:block space-y-6">
          ...
          <div
            ...
            onClick={() =>
              speakText(
                "2022-12-30 12:00, $8, 25 Grafton St, Worcester, Explore Watercolor Illustration"
              )
            }
          >
          ...
          <div
            ...
            onClick={() =>
              speakText(
                "2022-12-30 11:00 to 15:00, $16, 9 Grafton St, Worcester, Environment Conference"
              )
            }
          >
            <div className="flex items-center text-gray-600 mb-4">
          ...
          <div
            ...
            onClick={() =>
              speakText(
                "2022-12-30 17:00, Free, 88 Grafton St, Worcester, Digital Transformation Conference"
              )
            }
          >
            <div className="flex items-center text-gray-600 mb-4">
